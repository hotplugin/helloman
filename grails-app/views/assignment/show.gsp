	...
	<body>
		...
		<div id="show-assignment" class="content scaffold-show" role="main">
			...
			<ol class="property-list assignment">
				...
				<g:if test="${assignmentInstance?.students}">
				<li class="fieldcontain">
					<span id="students-label" class="property-label"><g:message code="assignment.students.label" default="Students" /></span>
					
						<g:each in="${assignmentInstance.students}" var="s">
